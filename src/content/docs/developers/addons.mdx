...
Both paths implement [`MenuExtension`](https://abstractmenus.github.io/api/ru/abstractmenus/api/MenuExtension.html). It has three lifecycle hooks plus three metadata methods.
