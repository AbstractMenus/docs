...
3. **Place a button**
   ...
   - `slot` - cell index, starting at 0. [Other slot formats](/docs/en/general/item-format/#slot) include ranges and matrices.
...
4. **Make the button do something on click**
   ...
   Reload, click the sword, the menu closes. Different mouse buttons can run different actions - see [click types](/docs/en/general/menu-structure/) for the full list.
...
See [logical structures](/docs/en/advanced/logical/) for nested rule trees and inversion.
